...
**2025, September:** ICT Lab will present 4 papers at ECOC 2025: W.01.04.2, W.01.05.4, W.02.01.56, and W.02.01.75. Our paper ``Lowering Error Floors for Hard Decision Decoding of OFEC Code'' (W.01.04.2, [arXiv](https://arxiv.org/abs/2507.12155)) is a part of the project [BIT-FREE](https://research.tue.nl/en/projects/hybrid-coded-modulation-for-reliable-and-power-efficient-coherent) funded by NWO via the Open Technology Programme. Our paper ``A New 5-bit/2D-symbol Modulation Format for Relative Intensity Noise-dominated IM-DD Systems'' (W.02.01.56, [arXiv](https://arxiv.org/abs/2506.01761)) is a result of our collaboration with Marvell Technology (USA).
